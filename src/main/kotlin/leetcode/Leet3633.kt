...
fun main() {
    println(earliestFinishTime(intArrayOf(2,8), intArrayOf(4,1), intArrayOf(6), intArrayOf(3)))
    println(earliestFinishTime(intArrayOf(5), intArrayOf(3), intArrayOf(1), intArrayOf(10)))
}
