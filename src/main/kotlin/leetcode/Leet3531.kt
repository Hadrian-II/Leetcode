...
fun main() {
    println(countCoveredBuildings(3, readArrayOfArrays("[[1,2],[2,2],[3,2],[2,1],[2,3]]")))
    println(countCoveredBuildings(3, readArrayOfArrays("[[1,1],[1,2],[2,1],[2,2]]")))
    println(countCoveredBuildings(1, readArrayOfArrays("[[1,3],[3,2],[3,3],[3,5],[5,3]]")))
}
